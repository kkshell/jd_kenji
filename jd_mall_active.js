        ...
        $.post(options, async (err, resp, data) => {
            try {
                if (err) {
                    ...
                    if (data) {
                        if ($.code === "vLg6n9v" || $.code === "vMg6o3B" || $.code === "vdgOjRT") {
